// pages/myRetrieve/myRetrieve.js
var app = getApp();
...
Page({
    ...
    if(memberId==""||memberId==null){
      wx.request({
        ...
        success(res) {
          ...
          app.get("/sortingOrder/getAllOrder", {
  ...
  doClickRetrieveDetail:function(e){
    // console.log(e.currentTarget.dataset.id);
    wx.navigateTo({
      url: "../retrieveDetail/retrieveDetail?id="+ JSON.stringify(e.currentTarget.dataset.id)
    })
  },
